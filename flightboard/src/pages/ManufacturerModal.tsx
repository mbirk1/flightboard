...
export default function ManufacturerModal() {
    ...
    useEffect(() => {
        ManufacturerService.getManufacturer().then((res: { data: SetStateAction<never[]>; }) => setManufacturer(res.data))
    }, []);


    return (
        <div>
            <Button text={"Flugzeug erstellen"} style={"create-button"} customClick={onClickButton}/>
