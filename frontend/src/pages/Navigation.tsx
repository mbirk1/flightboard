...
export default function Navigation(): React.ReactElement {
  ...
  useEffect(() => {
    setUser('alsfndaldnsl');
    document.cookie = 'Bearer='+user;
  });
                ...
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex-shrink-0 text-white">
                      <FontAwesomeIcon className="h-12 w-12" icon={'plane-departure'}></FontAwesomeIcon>
                    </div>
                      ...
                      <Menu as="div" className="relative ml-3">
                        <div>
                          ...
                          >
                            ...
                            <FontAwesomeIcon className="h-6 w-6 rounded-full text-white" icon="user" />
                          </Menu.Button>
                        </div>
                        <Transition
                          as={Fragment}
                  ...
                  <div className="-mr-2 flex md:hidden">
                    {/* Mobile menu button */}
                    <Disclosure.Button
                      className="relative inline-flex items-center justify-center rounded-md bg-gray-800
                    p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white
                ...
                <div className="border-t border-gray-700 pb-3 pt-4">
                  <div className="flex items-center px-5">
                    <div className="flex-shrink-0">
                      <FontAwesomeIcon className="h-10 w-10 rounded-full" icon="user" />
                    </div>
                    <div className="ml-3">
                      <div className="text-base font-medium leading-none text-white">Hallo</div>
